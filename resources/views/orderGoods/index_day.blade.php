...
@section('contents')
    @include('_errors')
    <form action="{{ route('orderGoods.index_day') }}" class="navbar-form navbar-left" method="get">
        <a href="{{ route('orderGoods.index') }}" class="btn btn-primary" role="button">按月份统计</a>
